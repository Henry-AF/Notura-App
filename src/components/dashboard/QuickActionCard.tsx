...
export function QuickActionCard({ label, href, colors }: QuickActionCardProps) {
  return (
    <Link
      href={href}
      className="group relative flex h-24 w-full flex-col justify-end overflow-hidden rounded-xl border border-white/20 p-4 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/60"
    >
