// Pure mapping from the raw meeting payload to page data. Shared by the
// server-side loader (meeting-api.ts) and the client-side refetch after
// processing completes (meeting-client-api.ts) — must stay free of
// server-only imports.
